      ...
      <head>
          ...
          <style>
              ...
              @media print {
                  ...
                  .professional-form-layout { border: none; }
                  .print-controls { display: none !important; }
      ...
      <div className="w-full max-w-4xl bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 sm:p-8 space-y-6">
          <header className="space-y-2">
            <div className="text-right">
              <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200">صندوق تقاعد موظفي الدولة</h2>
              <p className="text-md text-gray-600 dark:text-gray-400">فرع البصرة</p>
            </div>
            <div className="text-center">
                <div className="flex justify-center items-center gap-3 text-gray-700 dark:text-gray-200 pt-2">
          ...
          <div className="pt-6 border-t border-gray-200 dark:border-gray-700 flex flex-col items-center gap-4">
            ...
            <div className="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                <SaifAliLogoIcon className="w-10 h-10"/>
                <div className="text-right">
                    <p className="whitespace-nowrap">جميع الحقوق محفوظة &copy; {new Date().getFullYear()}</p>
                    <p className="font-semibold whitespace-nowrap">المبرمج سيف علي</p>
                </div>
            </div>
          </div>
      </div>
